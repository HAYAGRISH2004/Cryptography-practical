...
// Function to remove spaces and non-alphabetic characters from the input
...
void decryptPlayfair(char *text, char key[][5]) {
    ...
    for (int i = 0; i < len; i += 2) {
        ...
        // Find positions of characters a and b in the key matrix
        ...
        // Decrypt the pair based on positions in the key matrix
